...
var TerminalUI = function TerminalUI(socket) {
  var _this = this;

  _classCallCheck(this, TerminalUI);

  _defineProperty(this, "startListening", function () {
    _this.terminal.onData(function (data) {
  ...
  _defineProperty(this, "write", function (text) {
    return _this.terminal.write(text);
  });

  _defineProperty(this, "prompt", function () {
    return _this.terminal.write("\r\n$ ");
  });

  _defineProperty(this, "sendInput", function (input) {
    return _this.socket.emit('input', input);
  });

  _defineProperty(this, "attachTo", function (container) {
    _this.terminal.open(container);

    _this.terminal.write("Terminal Connected");
...
var _default = TerminalUI;
exports.default = _default;
},{"xterm":"node_modules/xterm/lib/xterm.js","xterm/css/xterm.css":"node_modules/xterm/css/xterm.css"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _socket = _interopRequireDefault(require("socket.io-client"));

var _TerminalUI = _interopRequireDefault(require("./TerminalUI"));
...
var startTerminal = function startTerminal(container) {
  return function (socket) {
    var terminal = new _TerminalUI.default(socket);
    terminal.attachTo(container);
    terminal.startListening();
  };
};

var connectToSocket = function connectToSocket(serverAddress) {
...
(function () {
  ...
  connectToSocket(serverAddress).then(startTerminal(container));
})();
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","./TerminalUI":"src/TerminalUI.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
